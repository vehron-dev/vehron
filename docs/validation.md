...
VEHRON now includes a small in-repo regression benchmark suite for the active
BEV path:

- [Reference Benchmarks](benchmarks.md)

That improves software verification, but it does not replace real-world physical
validation against measurements or literature references.
